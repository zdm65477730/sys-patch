...
public:
    ...
    tsl::elm::Element* createUI() override {
        ...
        list->addItem(new tsl::elm::CategoryHeader("NSGuiToggleCategoryHeaderText"_tr));
        list->addItem(config_ns1.create_list_item("NSForceGamecardRegionToGlobalGuiToggleToggleListItemText"_tr.c_str()));
        ...
        std::string jsonStr = R"(
            {
                ...
                "NSGuiToggleCategoryHeaderText": "NS Sysmodule - 010000000000001F",
                "NSForceGamecardRegionToGlobalGuiToggleToggleListItemText": "Force gamecard region to global",
